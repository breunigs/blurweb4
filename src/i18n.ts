...
const STRINGS = {
  en: {
    ...
    aria_prev: 'Show previous (arrow key left)',
    aria_file_select: 'Selected file',
    aria_next: 'Show next (arrow key right)',
    detecting: 'Detecting\u2026',
    ...
    setting_export_mode: 'Optimize for',
    export_mode_quality: 'Quality',
    export_mode_filesize: 'File size',
  ...
  de: {
    ...
    aria_prev: 'Vorheriges anzeigen (Pfeiltaste links)',
    aria_file_select: 'Ausgew\u00e4hlte Datei',
    aria_next: 'N\u00e4chstes anzeigen (Pfeiltaste rechts)',
    detecting: 'Erkennung\u2026',
    ...
    setting_export_mode: 'Optimieren für',
    export_mode_quality: 'Qualität',
    export_mode_filesize: 'Dateigröße',
