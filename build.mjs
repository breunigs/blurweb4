...
const buildVersion = new Date().toISOString().slice(0, 19).replace(/[-:T]/g, ''); // e.g. 20260117142359
...
const PRECACHE = ['/', '/src/style.css', '/dist/bundle.js', '/dist/hevcWorker.js?v=${version}', '/dist/detectorWorker.js?v=${version}', '/dist/blurWorker.js?v=${version}', '/dist/ocrWorker.js?v=${version}'];
